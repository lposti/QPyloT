...
class Ui_Plot1D_Window(object):
    def setupUi(self, Plot1D_Window):
        ...
        self.gridLayout_5.addWidget(self.line, 0, 1, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.tabWidget, 1, 2, 1, 2)
    ...
    def retranslateUi(self, Plot1D_Window):
        ...
        self.label_15.setText(_translate("Plot1D_Window", "File "))
        self.label_13.setText(_translate("Plot1D_Window", "Data X: "))
        self.label_14.setText(_translate("Plot1D_Window", "Data Y: "))
        self.label_16.setText(_translate("Plot1D_Window", "Column"))
        self.label_17.setText(_translate("Plot1D_Window", "DATA SERIES"))
        self.Rows_all_checkBox.setText(_translate("Plot1D_Window", "All"))
        self.label_20.setText(_translate("Plot1D_Window", "to"))
        self.label_18.setText(_translate("Plot1D_Window", "ROWS           "))
        self.Rows_from_checkBox.setText(_translate("Plot1D_Window", "From row"))
        self.label_19.setText(_translate("Plot1D_Window", " Every"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.Data_tab), _translate("Plot1D_Window", "Data"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("Plot1D_Window", "Axis"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.Label_tab), _translate("Plot1D_Window", "Labels"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("Plot1D_Window", "Markers"))
